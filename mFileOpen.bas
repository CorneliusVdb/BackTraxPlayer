...
Public Declare Function ShellExecute& Lib "Shell32.dll" Alias "ShellExecuteA" (ByVal hwnd&, ByVal lpszOp$, ByVal lpszFile$, ByVal lpszParams$, ByVal lpszdir$, ByVal fsShowCmd&)
